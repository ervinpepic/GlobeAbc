...
class WC_Gateway_Payssion_Brazil extends WC_Gateway_Payssion {
    protected $proceed_to = 'Ir para o';
	...
	*/
	public function payment_fields() {
		?>
		        ...
		        <script>
		        jQuery(function () {
                    jQuery('#payer_ref_<?php echo $this->pm_id;?>').on('keyup blur', function () {
				    ...
				    <p class="form-row form-row-first">
		                ...
		                <input class="input-text" type="text" size="18" maxlength="18" name="payer_ref_<?php echo $this->pm_id;?>" id="payer_ref_<?php echo $this->pm_id;?>" />
		            </p>  
		            <div class="clear"></div> 
			        <?php
	}
