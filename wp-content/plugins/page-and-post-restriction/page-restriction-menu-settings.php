        ...
        <div class="d-flex">
            <div class="col-md-9">
                ...
                if ($current_tab == '' || $current_tab == 'post_access' || $current_tab == 'category_access' || $current_tab == 'tag_access' ) { ?>
                    <div class="rounded bg-white papr-shadow p-4 mt-4 ml-2 mb-4 pl-0" id="restricted_behaviour">
                        <h4 class="papr-form-head">Restricted Content Behaviour
                            <div class="papr-info-global ml-2">
                                ...
                                <p class="papr-info-text-global">
                                    Choose what visitors will see if they don’t have permission to view the restricted content.
                                </p>
                            </div>
                        </h4>
                        ...
                        <div class="d-flex mt-4">
                            <div class="papr-prem-info mr-3">
                                <div class="papr-prem-icn" style="margin-left:20px;"><img src="<?php echo plugin_dir_url(__FILE__) ?>includes/images/lock.png" width="35px" />
                            ...
                            <div class="papr-prem-info">
                                <div class="papr-prem-icn papr-prem-icn-log" style="margin-left:20px;"><img src="<?php echo plugin_dir_url(__FILE__) ?>includes/images/lock.png" width="35px" />
                                    <p class="papr-prem-info-text">Available in <b>Paid</b> versions of the plugin. <a href=<?php echo admin_url('admin.php?page=page_restriction&tab=premium_plan'); ?> class="text-warning">Click here to upgrade</a></p>
            ...
            <div class="col-md-3 papr_support_col pl-0 pr-0">
...
{
?>
    <div class="wrap shadow-cstm p-3 mr-0 mt-0 mo-saml-margin-left bg-white">
        <div class="row align-items-center">
            <div class="col-md-5 h3 pl-3 d-flex align-items-center">
                <img src="<?php echo plugin_dir_url(__FILE__) ?>includes/images/miniorange-logo.png" alt="" width="50px" class="mr-2">
                <span>Page and Post Restriction</span>
            </div>
            <div class="col-md-3 text-center">
                <a id="license_upgrade" class="text-white pl-4 pr-4 pt-2 pb-2 papr-prem-btn" href="admin.php?page=page_restriction&tab=premium_plan">Premium Plans | Upgrade Now</a>
            </div>
            <div class="col-md-4 d-flex align-items-center justify-content-end">
                <a class="mr-3 text-white pl-5 pr-5 pt-3 pb-3 papr-prem-btn" target="_blank" href="https://faq.miniorange.com/kb/saml-single-sign-on/">FAQs</a>
                <a class="text-white pl-5 pr-5 pt-3 pb-3 papr-prem-btn" target="_blank" href="https://plugins.miniorange.com/wordpress-page-restriction">Know More</a>
            </div>
        </div>
    </div>
    <div class="nav-tab-wrapper papr-bg-main">
        <a class="nav-tab papr-nav-tab ml-3 <?php echo papr_set_active_tab($current_tab, ''); ?>" href="admin.php?page=page_restriction"> Page Access
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'post_access'); ?>" href="admin.php?page=page_restriction&tab=post_access"> Post Access
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'custom_restriction'); ?>" href="admin.php?page=page_restriction&tab=custom_restriction"> Block Access
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'tag_access'); ?>" href="admin.php?page=page_restriction&tab=tag_access"> Tag Access
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'category_access'); ?>" href="admin.php?page=page_restriction&tab=category_access"> Category Access
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'account_setup'); ?>" href="admin.php?page=page_restriction&tab=account_setup"> Account Setup
        </a>
        <a class="nav-tab papr-nav-tab <?php echo papr_set_active_tab($current_tab, 'premium_plan'); ?>" href="admin.php?page=page_restriction&tab=premium_plan"> Licensing Plans
        </a>
    </div>
<?php
}
...
{
?>
    <div class="rounded bg-white papr-shadow p-4 pl-0 mt-4 ml-2">
        ...
        <div class="row">
            ...
            <br>
        <div class="papr-prem-info">
            <div class="papr-prem-icn" style="margin-left:31em;"><img src="<?php echo plugin_dir_url(__FILE__) ?>includes/images/lock.png" width="35px" />
                <p class="papr-prem-info-text">Available in <b>Paid</b> versions of the plugin. <a href="<?php echo admin_url('admin.php?page=page_restriction&tab=premium_plan'); ?>">Click here to upgrade</a></p>
            </div>
            <div class="row">
...
{
    $admin_email = get_option("papr_admin_email")? get_option("papr_admin_email"): get_option("admin_email");;

?>
    <div class="rounded bg-white papr-shadow p-4 mr-0 mb-4 mr-3 mt-4">
        <div>
            ...
            <form method="post" action="">
                ...
                <table style="width:100%">
                    <tr>
                        <td>
                            <input class="w-100" type="email" required name="papr_contact_us_email" value="<?php echo $admin_email ?>" placeholder="Enter your email">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="tel" class="w-100 mt-4" id="contact_us_phone" pattern="[\+]\d{11,14}|[\+]\d{1,4}[\s]\d{9,10}" name="papr_contact_us_phone" value="<?php echo get_option('papr_admin_phone'); ?>" placeholder="Enter your phone">
                        </td>
                    </tr>
                    <tr>
                        <td>
    ...
    <div class="pt-3">
        <table>
            ...
            <tr>
                ...
                <td>
                    <button style="cursor: not-allowed;" class="btn papr-btn-cstm roundeds disabled value = "" placeholder = " Enter URL of the page">
                        <b>Save & Test URL </b>
                    </button>
                </td>
                </td>
            ...
            <tr>
                ...
                <td>
                    <button style="cursor: not-allowed;" class="btn papr-btn-cstm roundeds" disabled> Save & Preview</button>
                </td>
                </td>
            </tr>
            <tr>
    ...
    <div class="pt-3">
        ...
        <table>
            ...
            <tr>
                ...
                <td><b>
                        <button style="cursor: not-allowed;" class="btn papr-btn-cstm roundeds" disabled>Save & Test URL</button>
                </td>
                </td>
            </tr>
...
{
?>
    <div class="rounded bg-white papr-shadow p-4 mr-3">
        ...
        <div style="padding: 10px;">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo admin_url("admin.php?page=page_restriction&tab=premium_plan"); ?>"><input type="button" class="btn papr-btn-cstm rounded" value="Check Premium Plans" /></a>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="rounded bg-white papr-shadow p-4 pl-0 ml-2 mt-4">
        <form name="f" method="post" action="">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    <input class="mo_saml_table_textbox" style="width:100%" type="email" name="email" required placeholder="person@example.com" value="<?php echo (get_option('papr_admin_email') == '') ? get_option('admin_email') : get_option('papr_admin_email'); ?>" />
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-3">
    ...
    <form name="f" method="post" action="">
        ...
        <div class="rounded bg-white papr-shadow p-4 pl-0 mt-4 ml-2">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    <input class="mo_saml_table_textbox w-75" type="email" name="email" required placeholder="person@example.com" value="<?php echo get_option('papr_admin_email'); ?>" />
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-3">
