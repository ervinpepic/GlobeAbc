...
{
	$results_per_page = get_option('papr_category_per_page') != '' ? get_option('papr_category_per_page') : 5;
?>
...
{
?>
	<tr id="<?php echo get_category_link($category) ?>">
		<td>
			<a href="<?php echo get_category_link($category) ?>" target="_blank"><?php echo $category->name ?> &nbsp;
