<div class="booked-settings-prewrap">
	...
	if (!current_user_can('manage_booked_options') && $booked_none_assigned):
		...
		<div class="booked-settings-title"><?php esc_html_e('Pending Sessions','booked'); ?></div>

		<div class="booked-pending-cap bookedClearFix">
			<button class="delete-past button"><?php esc_html_e('Delete Passed Sessions','booked'); ?></button>
