...
function language_school_get_admin_page() {
	global $pagenow;
...
function language_school_default_tab() {
	$current_page = language_school_get_admin_page();
...
function language_school_get_the_tab() {
	global $pagenow;
	
	$default_tab = language_school_default_tab();
...
function language_school_settings_page_header() {
