...
add_action('admin_menu', 'language_school_add_menu');
add_action('admin_init', 'language_school_register_settings');


language_school_locate_template(CMSMASTERS_SETTINGS . '/inc/cmsmasters-helper-functions.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-general.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-font.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-color.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-element.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-single.php', true);
language_school_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-demo.php', true);


function language_school_get_settings() {
	$output = array();
	
	
	$page = language_school_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'language-school');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', language_school_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', language_school_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', language_school_options_general_tabs());
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'language-school');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', language_school_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', language_school_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', language_school_options_font_tabs());
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'language-school');
		$cmsmasters_page_sections = language_school_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', language_school_options_color_fields(), $tab);
		$cmsmasters_page_tabs = language_school_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'language-school');	
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', language_school_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', language_school_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', language_school_options_element_tabs());
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'language-school');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', language_school_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', language_school_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', language_school_options_single_tabs());
		...
		case 'tt_event':
			...
			break;
		case 'lpr_course':
			$cmsmasters_option_name = $cmsmasters_option_name . '_lpr_course';
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'language-school' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'language-school');
		$cmsmasters_page_sections = language_school_options_demo_sections();
		$cmsmasters_page_fields = language_school_options_demo_fields();
		$cmsmasters_page_tabs = language_school_options_demo_tabs();
...
function language_school_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'language-school'), 
		'desc' => 		esc_html__('This is a default description.', 'language-school'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function language_school_register_settings() {
	$settings_output = language_school_get_settings();
	...
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'language_school_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			language_school_create_settings_field($option);
		}
	}
...
function language_school_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'done' => 							esc_html__('All theme settings were imported successfully.', 'language-school'), 
		'fail' => 							esc_html__("Error on page!!!\nPlease reload page and try again.", 'language-school'), 
...
function language_school_add_menu() {
	$settings_output = language_school_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'language-school'), 
		esc_attr__('Theme Settings', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings', 
		'language_school_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'language-school'), 
		esc_attr__('General', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'language_school_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'language-school'), 
		esc_attr__('Fonts', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'language_school_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'language-school'), 
		esc_attr__('Colors', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'language_school_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'language-school'), 
		esc_attr__('Elements', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'language_school_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'language-school'), 
		esc_attr__('Single Posts', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'language_school_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'language-school'), 
		esc_attr__('Import/Export', 'language-school'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'language_school_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'language_school_settings_scripts');
}


function language_school_section_fn($desc) {
	$tab = language_school_get_the_tab();
...
function language_school_settings_page_fn() {
	$settings_output = language_school_get_settings();
	$current_tab = language_school_get_the_tab();
	
	echo '<div class="wrap">';
	
	language_school_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'language-school') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'language-school') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'language-school') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function language_school_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'language-school') . '" data-title="' . esc_attr__('Choose Image', 'language-school') . '" data-button="' . esc_attr__('Insert Image', 'language-school') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'language-school') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (language_school_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'language-school') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'language-school') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'language-school') . ' <em>(' . esc_html__('in pixels', 'language-school') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'language-school') . ' <em>(' . esc_html__('in pixels', 'language-school') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'language-school') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'language-school') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (language_school_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'language-school') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (language_school_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'language-school') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'language-school') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'language-school') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'language-school') . '"></a>' . 
			'</p>' . 
			...
			'<span class="icon_upload_link" style="display:none;">' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'language-school') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'language-school') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'language-school') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'language-school') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'language-school') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'language-school') . '"></a> ' . 
...
function language_school_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'language-school');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'language-school' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'language-school'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'language-school');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'language-school' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.', 'language-school'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'language-school');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'language-school');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'language-school' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'language-school'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'language-school');
...
function language_school_theme_admin_bar_render() {
	global $wp_admin_bar;
	
	
	$wp_admin_bar->add_menu(array( 
		'id' => 'language-school' . '_options', 
		'title' => esc_attr__('Theme Settings', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'language-school' . '_options', 
		'id' => 'language-school' . '_theme_settings', 
		'title' => esc_attr__('General', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'language-school' . '_options', 
		'id' => 'language-school' . '_theme_settings_font', 
		'title' => esc_attr__('Fonts', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-font')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'language-school' . '_options', 
		'id' => 'language-school' . '_theme_settings_color', 
		'title' => esc_attr__('Colors', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-color')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'language-school' . '_options', 
		'id' => 'language-school' . '_theme_settings_element', 
		'title' => esc_attr__('Elements', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-element')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'language-school' . '_options', 
		'id' => 'language-school' . '_theme_settings_single', 
		'title' => esc_attr__('Single', 'language-school'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-single')) 
	));
}

add_action('wp_before_admin_bar_render', 'language_school_theme_admin_bar_render');


function language_school_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function language_school_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			language_school_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				language_school_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'language_school_admin_msgs');


function language_school_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'language-school' . '_general', 
			language_school_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_bg', 
			language_school_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_header', 
			language_school_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_content', 
			language_school_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_footer', 
			language_school_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_font_content', 
			language_school_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_font_link', 
			language_school_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_font_nav', 
			language_school_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_font_heading', 
			language_school_options_font_fields('heading') 
		), 
		array( 
		...
		array( 
			...
			language_school_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_element_lightbox', 
			language_school_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_element_sitemap', 
			language_school_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_element_error', 
			language_school_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_element_code', 
			language_school_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			language_school_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_single_project', 
			language_school_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_single_profile', 
			language_school_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_single_tt_event', 
			language_school_options_single_fields('tt_event') 
		), 
		array( 
			'cmsmasters_options_' . 'language-school' . '_single_lpr_course', 
			language_school_options_single_fields('lpr_course') 
		)
	);
	...
	foreach (language_school_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'language-school' . '_color_' . $key, 
			language_school_options_color_fields($key) 
		));
	}
...
function language_school_get_global_options() {
	...
	foreach (language_school_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'language-school' . '_color_' . $key);
	}
