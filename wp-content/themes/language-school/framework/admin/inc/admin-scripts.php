...
function language_school_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 				esc_attr__('Clear', 'language-school'),
		'clearAriaLabel' => 	esc_attr__('Clear color', 'language-school'),
		'defaultLabel' => 		esc_attr__('Color value', 'language-school'),
		'defaultString' => 		esc_attr__('Default', 'language-school'),
		'defaultAriaLabel' => 	esc_attr__('Select default color', 'language-school'),
	...
	wp_localize_script('cmsmasters-uploader-js', 'cmsmasters_admin_uploader', array( 
		'choose' => 				esc_attr__('Choose image', 'language-school'), 
		'insert' => 				esc_attr__('Insert image', 'language-school'), 
		'remove' => 				esc_attr__('Remove', 'language-school'), 
		'edit_gallery' => 			esc_attr__('Edit gallery', 'language-school') 
	));
	...
	wp_localize_script('cmsmasters-lightbox-js', 'cmsmasters_admin_lightbox', array( 
		'cancel' => 				esc_attr__('Cancel', 'language-school'), 
		'insert' => 				esc_attr__('Insert', 'language-school'), 
		'deselect' => 				esc_attr__('Deselect', 'language-school'), 
		'choose_icon' => 			esc_attr__('Choose Icon', 'language-school'), 
		'find_icons' => 			esc_attr__('Find icons', 'language-school'), 
		'min_length' => 			esc_attr__('min 2 symbols', 'language-school'), 
		'choose_font' => 			esc_attr__('Choose icons font', 'language-school'), 
		'error_on_page' => 			esc_attr__("Error on page!\nReload page and try again.", 'language-school') 
	));
...
add_action('admin_enqueue_scripts', 'language_school_admin_register');
