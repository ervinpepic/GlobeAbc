...
function language_school_admin_register($hook) {
	...
	wp_enqueue_script('wp-color-picker');
		...
		'clear' => 					__('Clear', 'language-school'),
		'clearAriaLabel' => 		__('Clear color', 'language-school'),
		'defaultLabel' => 			__('Color value', 'language-school'),
		'defaultString' => 			__('Default', 'language-school'),
		'defaultAriaLabel' => 		__('Select default color', 'language-school'),
		'pick' => 					__('Select Color', 'language-school'),
	) ); 
