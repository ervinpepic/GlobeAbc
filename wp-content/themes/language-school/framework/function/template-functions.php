...
/* Disable Heading on LearnPress pages */
function language_school_learnpress_headline_type_filter( $type ) {
...
add_filter( 'cmsmasters_headline_type', 'language_school_learnpress_headline_type_filter' );
