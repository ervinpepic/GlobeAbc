...
function language_school_gutenberg_support() {
	$color_palettes = language_school_gutenberg_editor_color_palettes_styles();
...
function language_school_gutenberg_editor_color_palettes_styles( $get_styles = false ) {
...
function language_school_gutenberg_editor_custom_class( $classes ) {
	...
	if (
		...
		$cmsmasters_layout = ( get_post_meta( get_the_ID(), 'cmsmasters_layout', true ) == '' ) ? $cmsmasters_option['language-school' . '_blog_post_layout'] : get_post_meta( get_the_ID(), 'cmsmasters_layout', true );
	}
