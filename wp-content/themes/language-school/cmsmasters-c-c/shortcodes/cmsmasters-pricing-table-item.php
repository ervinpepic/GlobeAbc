...
if ($best == 'true') {
	if ($best_bg_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_price_wrap { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_bg_color) . 
			"\n\t" . cmsmasters_color_css('border-color', $best_bg_color) . 
		"\n" . '} ' . "\n" . 
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner:before { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_bg_color) . 
		"\n" . '} ' . "\n";
	}
